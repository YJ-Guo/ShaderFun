...
void Mesh::createCube(const char *textureFile, const char *bgTextureFile)
{
    ...
    // Create VBO data for positions, normals, UVs, and indices
    ...
    std::vector<glm::vec2> uvs {// Front Quad
                                glm::vec2(0, 0),
                                glm::vec2(1, 0),
                                glm::vec2(1, 1),
                                glm::vec2(0, 1),
    ...
    // Store the triangulated cube result
    std::vector<GLuint> idx {   // Front Quad
                                 0,  1,  2,  0,  2,  3,
                                // Right Quad
                                 4,  5,  6,  4,  6,  7,
                                // Back Quad
    ...
    count = 36; // Set "count" to the number of indices in your index VBO
